...
def add_combos_of_paper_index_to_list(
    ...
    if all_combos_of_authors(search_for_paper(paper_titles[paper_index])) != None:
...
for paper_index in range(
    ...
    if add_combos_of_paper_index_to_list(paper_index) != None:
        successful_papers += 1
...
for author in authors_list:  # gathers relevant data about each author
    ...
    if (
        author_object.affiliation_current != None
        and author_object.affiliation_current[0] != None
        and author_object.affiliation_current[0][8] != None
    ):
        country = author_object.affiliation_current[0][8]
        if author_object.affiliation_current[0][6] != None:
